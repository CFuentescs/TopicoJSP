    ...
    <body>
        ...
        <div class="container">
            <div class="col-lg-12 table-responsive">
                ...
                <h2>Total de Bonos por Empleado</h2>

                <table class="table table-striped ">

                    <thead>
                        <tr>
                            <th class="success">Rut del empleado</th>
                    ...
                    <tbody>
                        <c:forEach var="infoE" items="${info2}">
                            <tr>
                                <td>
                                    <c:out value="${infoE.rut}"/>
                                </td>
                                <td>
                                    <c:out value="${infoE.nombre}"/>
                                </td>
                              
                                <td>
                                    <c:out value="${infoE.nombre_carga}"/>
                                </td>
                                <td>
                                    <c:out value="${infoE.totalB}"/>
                                </td>
                                <td>
                                    <c:out value="${infoE.totalN}"/>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
